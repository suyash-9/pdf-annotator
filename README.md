...
PDF Annotator is a React Web app for PDF Annotations , highlights, editing. It provides a slick out-of-the-box responsive UI that interacts with the core library to view, annotate and manipulate PDFs that can be embedded into any web project.
